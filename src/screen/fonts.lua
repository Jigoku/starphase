...
fonts = {
	...
	hud = love.graphics.newFont("fonts/robotech-gp/ROBOTECH GP.ttf",20),
	hud_warning = love.graphics.newFont("fonts/robotech-gp/ROBOTECH GP.ttf",40),
	...
	message_header = love.graphics.newFont("fonts/robotech-gp/ROBOTECH GP.ttf",23),
	message_content = love.graphics.newFont("fonts/0xa000/0xA000-Squareish-Mono.ttf",17),
}
