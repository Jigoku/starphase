...
fonts = {
	...
	message_header = love.graphics.newFont("fonts/robotech-gp/ROBOTECH GP.ttf",24),
	message_content = love.graphics.newFont("fonts/0xa000/0xA000-Squareish-Mono.ttf",18),
}
